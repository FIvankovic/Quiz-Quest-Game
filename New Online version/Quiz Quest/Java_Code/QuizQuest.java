...
public class QuizQuest implements ActionListener
{
   ...
   */
   ...
   public QuizQuest()
   {
      ...
      paint = new DrawPane();
      quest.getContentPane().add(paint);//Gets the Graphics/Drawing pane
      quest.setTitle("QuizQuest");
      int screenWidth = Toolkit.getDefaultToolkit().getScreenSize().width; //width of board
      int screenHeight = Toolkit.getDefaultToolkit().getScreenSize().height;//height of board
      screenWidth = (screenWidth-quest.getWidth())/2 + 406;
      screenHeight = (screenHeight-quest.getHeight())/2;
      quest.setLocation(screenWidth,screenHeight);
   ...
   /**
   * getQuest method
   * return the JFrame quest
   * This is used to display the Quiz Quest frame to the two users
   */
   public JFrame getQuest() 
   {
	   return quest;
   }//getQuest method end
   ...
   public void actionPerformed(ActionEvent ae)
   {
      ...
      */
      else if (choice == jmiAbout)
      {
         ...
         JOptionPane.showMessageDialog(null,"<html>LOSER PAYS THE ULTIMATE <font color=#ff0000>PRICE OF BLOOD!</font></html>");
         ...
         JOptionPane.showMessageDialog(null,"If you find yourself struggling with the questions...");
         JOptionPane.showMessageDialog(null,"I won't help you!");
   ...
   class DrawPane extends JPanel
   {
      ...
      public void paintComponent(Graphics g)
      {
         ...
         //Cuts out 16 white spaces, which are the spaces players move on
   ...
   * This method works in conjunction with the setPosition static method
   ...
   */
   public static QuizQuest setPosition(int _player1Position,int _player2Position, int _playerTurn, boolean _colored)
   {
      //this.close();
   ...
   /*
   * setVisble (boolean b)
   * Method which hides/shows the QuizQuest frame depending on the boolean's state
   * This is needed to disable player inputs after the a move has been made and the game's object has been sent to the other player
   */
